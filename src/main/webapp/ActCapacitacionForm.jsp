			...
			<div class="container my-3">
				...
				<div class="row align-items-center">
					...
					<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-6">
						...
						<h2 class="display-6">Crear cambios en la Capacitacion</h2>
						<br />


						<form class="row g-3" method="post" action="EditarCapacitacionBD">
							
							<div class="col-md-6">
								<label for="inputCliente" class="form-label">Rut Cliente</label>
								<input type="text" class="form-control" name="inputCliente" required
									value="${capa.getRutCliente()}" placeholder="Alfanumerico">
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<label for="inputHora" class="form-label">Hora</label> <input
									type="text" class="form-control" name="inputHora" value="${capa.getHora()}" required
									placeholder="Formato HH:MM">
							</div>
							<div class="col-md-6">
								<label for="inputCiudad" class="form-label">Ciudad</label> <input
									type="text" class="form-control" name="inputCiudad" value="${capa.getLugar()}" required
									placeholder="Ciudad Capacitacion">
							</div>
							<div class="col-md-6">
								<label for="inputDuracion" class="form-label">Duracion</label> <input
									type="text" class="form-control" name="inputDuracion" value="${capa.getDuracion()}" required
									placeholder="Tiempo en minutos">
							</div>
							<div class="col-md-4">
								<label for="inputAsist" class="form-label">Num.
									Asistentes</label> <input type="text" class="form-control"
									name="inputAsist" value="${capa.getCantidad()}" required placeholder="Cantidad asistentes">
							</div>
							
										<input type="hidden" name="campoOculto" value="${capa.getIdentificador()}">
							
							<div>
								<button type="submit" class="btn btn-outline-primary">Actualizar Capacitacion</button>
							</div>
