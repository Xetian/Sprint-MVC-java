			...
			<div class="container my-3">
				...
				<div class="row align-items-center">
					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-6">
						...
						<h2 class="display-6">Agregar nuevo Usuario.</h2>
						<br />

							
						<form class="row g-3" method="post" action="CrearUsuario">

							<div class="col-md-6">
								<label for="inputNombre" class="form-label">Nombre</label> <input
									type="text" class="form-control" name="inputNombre"  required
									placeholder="Nombre Usuario">
							</div>
							<div class="col-md-6">
								<label for="inputEmail" class="form-label">Email</label> <input
									type="text" class="form-control" name="inputEmail"required
									placeholder="Correo electronico">
							</div>
							<div class="col-md-6">
								<label for="inputClave" class="form-label">Clave</label> <input
									type="text" class="form-control" name="inputClave" required
